...
pub fn pair<'a, M1, M2, In: 'a, Out1: 'a, Out2: 'a, Err1: 'a, Err2: 'a>(left: M1, right: M2) -> impl FallibleStateMonad<'a, In, (Out1, Out2), Either<Err1, Err2>>
    where
...
pub fn either<'a, M1, M2, In: 'a, Out1: 'a, Out2: 'a, Err1: 'a, Err2: 'a>(left: M1, right: M2) -> impl FallibleStateMonad<'a, In, Either<Out1, Out2>, (Err1, Err2)>
    where
        M1: FallibleStateMonad<'a, In, Out1, Err1>,
        M2: FallibleStateMonad<'a, In, Out2, Err2>,
{
